		...
		<div class="row">
			<div class="col-lg-6">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="user_firstname" value="<?php if(isset($user_firstname)) { echo $user_firstname; } else { echo ''; } ?>" disabled="disabled">
				</div>
				<div class="form-group">
					<label for="user_lastname">Last Name</label>
					<input type="text" class="form-control" name="user_lastname" value="<?php if(isset($user_lastname)) { echo $user_lastname; } else { echo ''; } ?>" disabled="disabled">
				</div>
				<div class="form-group">
			...
			<div class="form-group col-lg-6">
				<label for="user_image">Profile Image</label>
					...
					?>
				<input type="file" name="user_image" disabled="disabled">
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="user_email" value="<?php if(isset($user_email)) { echo $user_email; } else { echo ''; } ?>" disabled="disabled">
				</div>
				<div class="form-group">
					<label for="user_address">Address</label>
					<input type="text" class="form-control" name="user_address" value="<?php if(isset($user_address)) { echo $user_address; } else { echo ''; } ?>" disabled="disabled">
				</div>
				<div class="form-group">
					<label for="user_phone">Phone</label>
					<input type="text" class="form-control" name="user_phone" value="<?php if(isset($user_phone)) { echo $user_phone; } else { echo ''; } ?>" disabled="disabled">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="password" class="form-control" name="password" value="<?php if(isset($password)) { echo $password; } else { echo ''; } ?>" disabled="disabled">
				</div>
			</div>
		</div>
